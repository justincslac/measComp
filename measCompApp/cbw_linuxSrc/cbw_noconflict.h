...
#define CBW_SIMULTANEOUS     0x0200    /* Simultaneous D/A output */
...
#define CBW_NOCALIBRATEDATA  0x8000    /* Return uncalibrated PCM data */
...
#define CBW_NOCLEAR			 0x0800	   /* Disables clearing counters when scan starts */
...
#define CBW_AUXPORT          1
#define CBW_AUXPORT0         1
#define CBW_AUXPORT1         2
#define CBW_AUXPORT2         3
#define CBW_FIRSTPORTA       10
#define CBW_FIRSTPORTB       11
#define CBW_FIRSTPORTCL      12
#define CBW_FIRSTPORTC		 12
#define CBW_FIRSTPORTCH      13
#define CBW_SECONDPORTA      14
#define CBW_SECONDPORTB      15
#define CBW_SECONDPORTCL     16
#define CBW_SECONDPORTCH     17
#define CBW_THIRDPORTA       18
#define CBW_THIRDPORTB       19
#define CBW_THIRDPORTCL      20
#define CBW_THIRDPORTCH      21
#define CBW_FOURTHPORTA      22
#define CBW_FOURTHPORTB      23
#define CBW_FOURTHPORTCL     24
#define CBW_FOURTHPORTCH     25
#define CBW_FIFTHPORTA       26
#define CBW_FIFTHPORTB       27
#define CBW_FIFTHPORTCL      28
#define CBW_FIFTHPORTCH      29
#define CBW_SIXTHPORTA       30
#define CBW_SIXTHPORTB       31
#define CBW_SIXTHPORTCL      32
#define CBW_SIXTHPORTCH      33
#define CBW_SEVENTHPORTA     34
#define CBW_SEVENTHPORTB     35
#define CBW_SEVENTHPORTCL    36
#define CBW_SEVENTHPORTCH    37
#define CBW_EIGHTHPORTA      38
#define CBW_EIGHTHPORTB      39
#define CBW_EIGHTHPORTCL     40
#define CBW_EIGHTHPORTCH     41
...
{
	CBW_USB_IFC = 1 << 0,
	CBW_BLUETOOTH_IFC = 1 << 1,
	CBW_ETHERNET_IFC = 1 << 2,
	CBW_ANY_IFC  = CBW_USB_IFC | CBW_BLUETOOTH_IFC | CBW_ETHERNET_IFC
} CBW_DaqDeviceInterface;
...
typedef struct 
{
	...
	CBW_DaqDeviceInterface		InterfaceType;		// USB, BLUETOOTH, ...
	CHAR					DevString[64];
...
#undef EVENTCALLBACK
   ...
   int EXTCCONV cbGetCalCoeff(int BoardNum, int FunctionType, int Channel, int Range, int Item, int* Value);
	...
	int EXTCCONV cbCreateDaqDevice(int BdNum, CBW_DaqDeviceDescriptor DeviceDescriptor);
	int EXTCCONV cbGetDaqDeviceInventory(CBW_DaqDeviceInterface InterfaceType, CBW_DaqDeviceDescriptor* Inventory, INT* NumberOfDevices);
	int EXTCCONV cbReleaseDaqDevice(int BdNum);
	int EXTCCONV cbGetBoardNumber (CBW_DaqDeviceDescriptor DeviceDescriptor);
	int EXTCCONV cbGetNetDeviceDescriptor(CHAR* Host, INT Port, CBW_DaqDeviceDescriptor* DeviceDescriptor, INT Timeout);
